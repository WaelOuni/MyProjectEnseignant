 ...
 */
public class LogA extends Activity {
/**
 ...
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (EditText) findViewById(R.id.loginAuth);
        ...
        mPasswordView
                .setOnEditorActionListener(new TextView.OnEditorActionListener() {
                    ...
                    public boolean onEditorAction(TextView textView, int id,
                                                  KeyEvent keyEvent) {
                        if (id == R.id.loginAuth || id == EditorInfo.IME_NULL) {
                            attemptLogin();
                            return true;
                        }
                        return false;
        ...
        findViewById(R.id.inscriptionLink).setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View arg0) {

                Toast.makeText(getApplicationContext(), "Faire votre inscription à notre app", Toast.LENGTH_LONG).show();
                startActivity(new Intent(getApplicationContext(),inE.class ));
            }
        });
    }
...
///////////////    mettre les donnes de l'authentification a partir de bd
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                startActivity(new Intent(getApplicationContext(), LogA.class));
            }
        }
